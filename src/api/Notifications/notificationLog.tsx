...
import { ConfirmModal, ListScrollerThin, Modal, openModal, Timestamp, useEffect, useReducer, useState } from "@webpack/common";
...
function LogModal(props: ModalPropsRender) {
