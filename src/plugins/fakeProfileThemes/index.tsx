...
import type { User, UserProfile } from "@velocity-types";
import { findComponentByCodeLazy } from "@webpack";
import { Buttons, ColorPicker, Forms, UserProfileStore, UserStore, useState } from "@webpack/common";
            ...
            <SectionHeader
                ...
                description={<>
                    ...
                    <div className={Margins.top8}>
                        ...
                        <div className="vc-fpt-color-pickers">
                            <ColorPicker
                                color={color1}
                                label="Primary"
...
export default definePlugin({
    ...
    addCopy3y3Button: ErrorBoundary.wrap(function ({ primary, accent }: Colors) {
        return <div className={Margins.left16}>
            <Buttons.Button
                text="Copy 3y3"
                onClick={() => {
