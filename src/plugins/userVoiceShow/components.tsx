...
import { ChannelRouter, ChannelStore, Parser, PermissionsBits, PermissionStore, type React, showToast, Text, Toasts, Tooltip, useMemo, UserStore, UserSummaryItem, useStateFromStores, VoiceStateStore } from "@webpack/common";
...
function Icon(props: React.PropsWithChildren<IconProps>) {
    const {
        size = 16,
        className,
        iconClassName,
