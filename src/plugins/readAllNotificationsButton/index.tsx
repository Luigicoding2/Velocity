...
import type { ChannelRecord } from "@velocity-types";
import { ActiveJoinedThreadsStore, Buttons, FluxDispatcher, GuildChannelStore, GuildStore, ReadStateStore } from "@webpack/common";
        ...
        GuildChannelStore.getChannels(guild.id).SELECTABLE // Array<{ channel, comparator }>
            ...
            .concat(
                Object.values(ActiveJoinedThreadsStore.getActiveJoinedThreadsForGuild(guild.id))
                    ...
                    .map((t): ChannelRecord => ({ channel: t.channel, comparator: -1 }))
            )
