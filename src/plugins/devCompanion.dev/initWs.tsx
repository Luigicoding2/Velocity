...
import type { FullOutgoingMessage, OutgoingMessage } from "./types/send";
            ...
            case "testPatch": {
                ...
                for (const { match, replace } of m.replacement) {
                    ...
                    try {
                        ...
                        const replacement = canonicalizeReplace(parseNode(replace), 'Velocity.Plugins.plugins["PlaceHolderPluginName"]');
