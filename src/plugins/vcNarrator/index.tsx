...
import { Buttons, ChannelStore, Forms, GuildMemberStore, SelectedChannelStore, SelectedGuildStore, useMemo, UserStore, VoiceStateStore } from "@webpack/common";
...
export default definePlugin({
    ...
    flux: {
        VOICE_STATE_UPDATES({ voiceStates }: { voiceStates: VoiceStateChangeEvent[]; }) {
            ...
            if (ChannelStore.getChannel(myChanId!)?.type === ChannelType.GUILD_STAGE_VOICE) return;
