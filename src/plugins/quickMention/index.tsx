...
import { Icon as IconWrapper } from "@components/Icons";
import { Devs } from "@utils/constants";
import { insertTextIntoChatInputBox } from "@utils/discord";
import definePlugin from "@utils/types";
import { ChannelStore, PermissionsBits, PermissionStore, PopoverClasses } from "@webpack/common";

function Icon() {
    return (
        <IconWrapper
            className={PopoverClasses.icon}
            height="24"
            width="24"
            viewBox="0 0 24 24"
            fill="currentColor"
