...
const Native = VelocityNative.pluginHelpers.Translate as PluginNative<typeof import("./native")>;
...
export async function translate(kind: "received" | "sent", text: string, lang?: DiscordLocale): Promise<TranslationValue> {
    ...
    try {
        return await translate(
            ...
            lang ?? settings.store[`${kind}Output`]
        );
    } catch (e) {
