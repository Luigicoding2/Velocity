...
import { Icons, Menu, UserStore } from "@webpack/common";
...
export default definePlugin({
    ...
    contextMenus: {
        "guild-context": { render: makeContextMenuPatch(false), required: true },
        "guild-header-popout": { render: makeContextMenuPatch(true), required: true }
    },
    patches: [
        {
            find: ",acceptInvite(",
