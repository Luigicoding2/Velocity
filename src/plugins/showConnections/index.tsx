...
import type { ConnectedAccount, User } from "@velocity-types";
...
function CompactConnectionComponent({ connection, theme }: { connection: ConnectedAccount, theme: string; }) {
    ...
    const TooltipIcon = url ? Icons.LinkIcon : Icons.CopyIcon;
        ...
        <Tooltip
            text={
                <span className="vc-sc-tooltip">
                    ...
                    <TooltipIcon size="xs" className="vc-sc-tooltip-icon" />
                </span>
            }
            key={connection.id}
        >
