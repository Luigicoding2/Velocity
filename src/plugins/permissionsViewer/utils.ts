...
import type { Guild, GuildMember, Role } from "@velocity-types";
...
export const { getGuildPermissionSpecMap, generateGuildPermissionSpec } = findByPropsLazy("getGuildPermissionSpecMap");
