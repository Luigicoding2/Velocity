...
export interface StreamContextProps {
    ...
    position: string,
    target: HTMLElement,
    stream: ApplicationStreamingStoreTypes.ActiveStream,
    theme: string,
}

export const handleViewPreview = ({ guildId, channelId, ownerId }: ApplicationStreamingStoreTypes.ApplicationStream | ApplicationStreamingStoreTypes.ActiveStream) => {
