...
import { Buttons, ChannelStore, GuildRoleStore, GuildStore, UserStore } from "@webpack/common";
...
export default definePlugin({
    ...
    settingsAboutComponent: () => (
        <Buttons.Button text="Send test notification" onClick={() => sendOtherNotif("This is a test notification! explode", "Hello from Vendor!")} />
    )
});
