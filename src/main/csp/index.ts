...
export const CspPolicies: PolicyMap = {
    ...
    "cdn.discordapp.com": ImageAndCssSrc, // Discord CDN, used by Velocity and some themes to load media
    "discord.com": ImageSrc, // Discord, used by Velocity and some themes to load images/svg
    "media.discordapp.net": ImageSrc, // Discord media CDN, possible alternative to Discord CDN

    // CDNs used for some things by Velocity.
...
const patchCsp = (headers: PolicyMap) => {
    ...
    if (header) {
        ...
        // we could make unsafe-inline safe by using strict-dynamic with a random nonce on our Velocity loader script https://content-security-policy.com/strict-dynamic/
        ...
        for (const directive of ["style-src", "connect-src", "img-src", "font-src", "media-src", "worker-src"]) {
            pushDirective(directive, "blob:", "data:", "velocity:");
        }
