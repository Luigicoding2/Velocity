...
export interface Patch {
    ...
    /** Only set this to true if the module's patch find is lazy loaded */
    lazy?: boolean;
...
export interface PluginDef {
    ...
    */
     ...
     */
    contextMenus?: Record<string, ContextMenuDef>;
    /**
    ...
    userProfileBadge?: ProfileBadge | ProfileBadge[];
...
export const enum StartAt {
    /** Right away, as soon as Velocity initialised */
    Init = "Init",
